...
public final class NotificationBinding implements ViewBinding {
  ...
  private NotificationBinding(@NonNull RelativeLayout rootView, @NonNull ImageView Logo,
  ...
  public static NotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NotificationBinding((RelativeLayout) rootView, Logo, description, title);
    }
