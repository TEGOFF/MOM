...
public final class CategoryItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout clCatsLay;

  @NonNull
  public final TextView tvCatName;

  private CategoryItemBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout clCatsLay, @NonNull TextView tvCatName) {
    this.rootView = rootView;
    this.clCatsLay = clCatsLay;
  ...
  public static CategoryItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout clCatsLay = (ConstraintLayout) rootView;
      ...
      return new CategoryItemBinding((ConstraintLayout) rootView, clCatsLay, tvCatName);
    }
